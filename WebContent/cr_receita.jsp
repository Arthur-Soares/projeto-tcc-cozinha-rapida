...
<html>
	...
	<script type="text/javascript">
		...
		//FunÁ„o do efeito favotitar receita no icone Hearth
						...
						<div class="modal-header">
							...
							<div class="row">
						        ...
						        for (int i = 0; i < quantidade; i++) {
						        	divId = "div_"+i; // Gera um ID ˙nico para cada div
						        
						        %>						        <!-- Botıes de somar e subtrair ingredientes -->
								...
								<!-- DescriÁ„o do ingrediente -->
								<div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-5 ingDsc spc" style="margin-bottom: 20px;"> 
									
									<h4 style="text-align: center; font-size: 15px; font-weight: bold; color: #b1463c"> DescriÁ„o </h4>
